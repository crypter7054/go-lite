                        ...
                        ListTile(
                          title: TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              labelText:
                                  "Tanggal Kedaluwarsa (hari/bulan/tahun)", //label text of field
                              border: OutlineInputBorder(),
                            ),
                            readOnly:
                                    ...
                                    setState(() {
                                      setState(() {
                                        for (int i = 0;
                                            ...
                                            i++) {
                                          if (availableHobbies[i]
                                                  ['isChecked'] ==
                                              true) {
                                            payment.add(
                                                availableHobbies[i]['name']);
                                          }
                                        }
                                        if (pilih_jenis_voucher ==
                                            confirmation.harga_tetap) {
                                          MongoDatabase.updateVoucherTetap(
                                              widget.id,
                                              name.text,
                                              desc.text,
                                              int.parse(discount_price.text),
                                              int.parse(min_trans.text),
                                              payment,
                                              guide.text,
                                              expire_date);
                                        } else if (pilih_jenis_voucher ==
                                            confirmation.persen) {
                                          MongoDatabase.updateVoucherPersen(
                                              widget.id,
                                              name.text,
                                              desc.text,
                                              int.parse(discount_percent.text),
                                              int.parse(max_disc.text),
                                              int.parse(min_trans.text),
                                              payment,
                                              guide.text,
                                              expire_date);
